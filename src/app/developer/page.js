...
const Developer = () => {
  return (
    ...
    <AboutCore/>
        ...
        <div className='g4 w-[300px] h-[300px] xs:w-[390px] xs:h-[450px] sm:w-[400px] sm:h-[400px] md:w-[450px] md:h-[450px] lg:w-[500px] lg:h-[500px] mt-[470%] xs:mt-[360%] xs:ml-[5%] sm:mt-[250%] sm:-ml-[5%] md:mt-[210%] md:-ml-[5%] lg:mt-[170%] lg:ml-[25%] xl:hidden  '></div>
