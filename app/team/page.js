...
const team = () => {
  return (
    ...
    <AboutCore/>
        ...
        <div className='g3 w-[300px] h-[300px] xs:w-[390px] xs:h-[450px] sm:w-[400px] sm:h-[400px] md:w-[450px] md:h-[450px] lg:w-[500px] lg:h-[500px] mt-[390%] xs:mt-[350%] xs:ml-[5%] sm:mt-[210%] sm:ml-[35%] md:mt-[180%] md:ml-[30%] lg:mt-[150%] lg:ml-[45%] xl:hidden  '></div>
