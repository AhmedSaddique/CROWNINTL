  ...
  return (
    ...
    <div className={` relative `}>
      ...
      <Blog/>
        ...
        <div className='g2 w-[300px] h-[300px] xs:w-[390px] xs:h-[450px] sm:w-[400px] sm:h-[400px] md:w-[450px] md:h-[450px] lg:w-[500px] lg:h-[500px] mt-[60%] xs:mt-[40%]  xs:ml-[5%] sm:mt-[20%]  sm:ml-[15%] md:mt-[18%]  md:ml-[20%] lg:mt-[15%]  lg:ml-[20%] xl:mt-[10%] xl:ml-[15%]  xxl:hidden'></div>
        ...
        <div className='g4 w-[300px] h-[300px] xs:w-[390px] xs:h-[450px] sm:w-[400px] sm:h-[400px] md:w-[450px] md:h-[450px] lg:w-[500px] lg:h-[500px] mt-[200%] xs:mt-[180%] xs:ml-[5%] sm:mt-[115%] sm:ml-[5%]  md:mt-[100%] md:-ml-[5%] lg:mt-[80%]  lg:ml-[25%] xl:mt-[50%] xl:ml-[58%]  xxl:hidden'></div>
        <div className='g1 w-[300px] h-[300px] xs:w-[390px] xs:h-[450px] sm:w-[400px] sm:h-[400px] md:w-[450px] md:h-[450px] lg:w-[500px] lg:h-[500px] mt-[260%] xs:mt-[240%] xs:ml-[5%] sm:mt-[150%] sm:ml-[35%] md:mt-[130%] md:ml-[30%] lg:mt-[110%] lg:-ml-[5%] xl:mt-[70%] xl:ml-[35%]  xxl:hidden'></div>
        <div className='g2 w-[300px] h-[300px] xs:w-[390px] xs:h-[450px] sm:w-[400px] sm:h-[400px] md:w-[450px] md:h-[450px] lg:w-[500px] lg:h-[500px] mt-[310%] xs:mt-[280%] xs:ml-[5%] sm:mt-[170%] sm:-ml-[5%] md:mt-[150%] md:-ml-[5%] lg:mt-[120%] lg:ml-[20%] xl:mt-[90%] xl:ml-[15%]  xxl:hidden'></div>
        <div className='g3 w-[300px] h-[300px] xs:w-[390px] xs:h-[450px] sm:w-[400px] sm:h-[400px] md:w-[450px] md:h-[450px] lg:w-[500px] lg:h-[500px] mt-[390%] xs:mt-[350%] xs:ml-[5%] sm:mt-[210%] sm:ml-[35%] md:mt-[180%] md:ml-[30%] lg:mt-[150%] lg:ml-[45%] xl:mt-[110%] xl:ml-[35%]  xxl:hidden'></div>
        <div className='g4 w-[300px] h-[300px] xs:w-[390px] xs:h-[450px] sm:w-[400px] sm:h-[400px] md:w-[450px] md:h-[450px] lg:w-[500px] lg:h-[500px] mt-[470%] xs:mt-[360%] xs:ml-[5%] sm:mt-[250%] sm:-ml-[5%] md:mt-[210%] md:-ml-[5%] lg:mt-[170%] lg:ml-[25%] xl:mt-[130%] xl:ml-[58%]  xxl:hidden'></div>
        ...
        <div className='g3 w-[300px] h-[300px] xs:w-[390px] xs:h-[450px] sm:w-[400px] sm:h-[400px] md:w-[450px] md:h-[450px] lg:w-[500px] lg:h-[500px]  sm:hidden md:block md:mt-[180%] md:ml-[30%] lg:mt-[260%] lg:ml-[45%] xl:mt-[220%] xl:ml-[35%]  xxl:hidden'></div>
        <div className='g4 w-[300px] h-[300px] xs:w-[390px] xs:h-[450px] sm:w-[400px] sm:h-[400px] md:w-[450px] md:h-[450px] lg:w-[500px] lg:h-[500px]  sm:hidden md:block md:mt-[210%] md:-ml-[5%] lg:mt-[300%] lg:ml-[25%] xl:mt-[250%] xl:ml-[58%]  xxl:hidden'></div>
