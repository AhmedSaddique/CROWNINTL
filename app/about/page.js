  ...
  return (
    ...
    <div className={` relative `}>
      ...
      <Blog/>
        ...
        <div className='g1 w-[300px] h-[300px] xs:w-[390px] xs:h-[450px] sm:w-[400px] sm:h-[400px] md:w-[450px] md:h-[450px] lg:w-[500px] lg:h-[500px] mt-[520%] xs:mt-[350%] xs:ml-[5%] sm:mt-[290%] sm:ml-[35%] md:mt-[220%] md:ml-[30%] lg:mt-[180%] lg:-ml-[5%] xl:mt-[160%] xl:ml-[35%]  '></div>
        
        <div className='g2 w-[300px] h-[300px] xs:w-[390px] xs:h-[450px] sm:w-[400px] sm:h-[400px] md:w-[450px] md:h-[450px] lg:w-[500px] lg:h-[500px]  sm:hidden md:block md:mt-[150%] md:-ml-[5%] lg:mt-[220%] lg:ml-[20%] xl:mt-[190%] xl:ml-[15%]  '></div>
        <div className='g3 w-[300px] h-[300px] xs:w-[390px] xs:h-[450px] sm:w-[400px] sm:h-[400px] md:w-[450px] md:h-[450px] lg:w-[500px] lg:h-[500px]  sm:hidden md:block md:mt-[180%] md:ml-[30%] lg:mt-[260%] lg:ml-[45%] xl:mt-[220%] xl:ml-[35%]  '></div>
        <div className='g4 w-[300px] h-[300px] xs:w-[390px] xs:h-[450px] sm:w-[400px] sm:h-[400px] md:w-[450px] md:h-[450px] lg:w-[500px] lg:h-[500px]  sm:hidden md:block md:mt-[210%] md:-ml-[5%] lg:mt-[300%] lg:ml-[25%] xl:mt-[250%] xl:ml-[58%]  '></div>
