  ...
  return (
    ...
    <Hero/>
      ...
      {/* <Newsletter/> */}
        ...
        <div className='g1 w-[300px] h-[300px] xs:w-[390px] xs:h-[450px] sm:w-[400px] sm:h-[400px] md:w-[450px] md:h-[450px] lg:w-[500px] lg:h-[500px] mt-[200%] xs:mt-[180%] xs:ml-[5%] sm:mt-[115%] sm:ml-[5%]  md:mt-[100%] md:-ml-[5%] lg:mt-[80%]  lg:ml-[25%] xl:mt-[50%] xl:ml-[58%]  '></div>
        <div className='g2 w-[300px] h-[300px] xs:w-[390px] xs:h-[450px] sm:w-[400px] sm:h-[400px] md:w-[450px] md:h-[450px] lg:w-[500px] lg:h-[500px] mt-[260%] xs:mt-[240%] xs:ml-[5%] sm:mt-[150%] sm:ml-[35%] md:mt-[130%] md:ml-[30%] lg:mt-[110%] lg:-ml-[5%] xl:mt-[70%] xl:ml-[35%]  '></div>
